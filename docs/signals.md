...
Every symbol, and an XOR example carried through, in [`signals-worked.md`](signals-worked.md).
...
The symbols one by one, and the XOR gate's four gradients worked out, in [`signals-worked.md`](signals-worked.md).
